...
let translations = [
    ...
    ["dash_card_phocos_settings", "Phocos Parameters", "Paramètres Phocos"],
...
let dashboardMetricStrings = [
    ...
    ["metric_total_output_active_power", "Total active output", "Sortie active totale"],
    ["metric_total_output_apparent_power", "Total apparent output", "Sortie apparente totale"],
    ["metric_solar_to_house", "Solar to house", "Solaire vers maison"],
    ["metric_battery_to_house", "Battery to house", "Batterie vers maison"],
    ["metric_grid_to_house", "Grid to house", "Réseau vers maison"],
    ["metric_battery_soc", "State of charge", "État de charge"],
    ["metric_battery_state", "Battery status", "État de la batterie"],
    ["metric_battery_type", "Battery type", "Type batterie"],
    ...
    ["metric_battery_charge_power", "Charge power", "Puissance de charge"],
    ["metric_battery_discharge_power", "Discharge power", "Puissance de décharge"],
    ["metric_total_charging_current", "Total charging current", "Courant total de charge"],
    ["metric_battery_rating_voltage", "Nominal battery voltage", "Tension nominale batterie"],
    ["metric_battery_bulk_voltage", "Bulk voltage", "Tension bulk"],
    ["metric_battery_float_voltage", "Float voltage", "Tension float"],
    ["metric_battery_recharge_voltage", "Recharge voltage", "Tension de recharge"],
    ["metric_battery_redischarge_voltage", "Re-discharge voltage", "Tension de redécharge"],
    ["metric_battery_under_voltage", "Under-voltage threshold", "Seuil sous-tension"],
    ["metric_max_charging_current", "Max charging current", "Courant charge max"],
    ["metric_max_ac_charging_current", "Max grid charging current", "Courant charge secteur max"],
    ...
    ["metric_solar_to_battery", "Solar to battery", "Solaire vers batterie"],
    ["metric_solar_feed_to_grid", "Solar to grid", "Solaire vers réseau"],
    ["metric_grid_to_battery", "Grid to battery", "Réseau vers batterie"],
    ...
    ["metric_pv_ok_condition", "PV acceptance condition", "Condition d'acceptation PV"],
    ["metric_pv_power_balance", "PV power balance", "Équilibrage puissance PV"],
    ...
    ["metric_device_id", "Device ID", "ID appareil"],
    ...
    ["metric_input_voltage_range", "Input voltage range", "Plage tension entrée"],
    ["metric_machine_type", "Machine type", "Type machine"],
    ["metric_topology", "Topology", "Topologie"],
    ["metric_rated_active_power", "Rated active power", "Puissance active nominale"],
    ["metric_rated_apparent_power", "Rated apparent power", "Puissance apparente nominale"],
    ["metric_rated_output_current", "Rated output current", "Courant sortie nominal"],
    ["metric_battery_redischarge_voltage_scc", "Re-discharge voltage (solar charger)", "Tension de redécharge solaire"],
    ["metric_cv_charge_time", "Constant-voltage charge time", "Durée charge CV"],
    ["metric_battery_type_code", "Battery type code", "Code type batterie"],
    ["metric_charger_priority_code", "Charger priority code", "Code priorité chargeur"],
    ["metric_grid_rating_voltage", "Grid rating voltage", "Tension nominale réseau"],
    ["metric_grid_rating_current", "Grid rating current", "Courant nominal réseau"],
    ["metric_output_rating_voltage", "Output rating voltage", "Tension nominale sortie"],
    ["metric_output_rating_frequency", "Output rating frequency", "Fréquence nominale sortie"],
    ["metric_max_parallel_units", "Max parallel units", "Unités parallèles max"],
    ["metric_country_code", "Country code", "Code pays"],
    ["metric_input_voltage_range_code", "Input range code", "Code plage entrée"],
    ["metric_output_priority_code", "Output priority code", "Code priorité sortie"],
    ["metric_machine_type_code", "Machine type code", "Code type machine"],
    ["metric_topology_code", "Topology code", "Code topologie"],
    ["metric_pv_ok_condition_code", "PV condition code", "Code condition PV"],
    ["metric_pv_power_balance_code", "PV balance code", "Code équilibre PV"],
    ["metric_reserved_setting_26", "Reserved setting 26", "Réglage réservé 26"],
    ["metric_reserved_setting_27", "Reserved setting 27", "Réglage réservé 27"],
    ...
    ["metric_warning_bitmap", "Warning bitmap", "Bits d'alerte"],
    ["metric_flag_blob", "Enabled flags", "Flags actifs"],
    ["metric_status_bits", "Status bits", "Bits d'état"],
];
...
let dashboardValueStrings = {
    ...
    metric_battery_type: {
        "AGM": ["AGM", "AGM"],
        "Flooded": ["Flooded", "Plomb ouvert"],
        "User defined": ["User defined", "Personnalisée"],
    ...
    metric_input_voltage_range: {
        ...
        "UPS": ["UPS", "Onduleur UPS"],
        "Unknown": ["Unknown", "Inconnu"],
    },
    metric_machine_type: {
        "Grid tie": ["Grid tie", "Raccordé réseau"],
        "Off-grid": ["Off-grid", "Autonome"],
        "Hybrid": ["Hybrid", "Hybride"],
        "Unknown hybrid variant": ["Unknown hybrid", "Hybride inconnu"],
        "Unknown": ["Unknown", "Inconnu"],
    },
    metric_topology: {
        "Transformerless": ["Transformerless", "Sans transformateur"],
        "Transformer": ["Transformer", "Avec transformateur"],
        "Unknown": ["Unknown", "Inconnu"],
    },
    metric_pv_ok_condition: {
        "PV power at any level": ["PV power at any level", "Puissance PV à tout niveau"],
        "PV power must exceed configured threshold": ["PV must exceed threshold", "PV au-dessus du seuil configuré"],
        "Unknown": ["Unknown", "Inconnu"],
    },
    metric_pv_power_balance: {
        "PV power balance disabled": ["Disabled", "Désactivé"],
        "PV power balance enabled": ["Enabled", "Activé"],
        "Unknown": ["Unknown", "Inconnu"],
    },
    metric_fault: {
        "No fault": ["None", "Aucun"],
